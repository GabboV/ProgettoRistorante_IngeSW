...
public class Ricetta implements Serializable {
	...
	private List<Prodotto> elencoIngredienti;
	private int numeroPorzioni;
	private int caricoLavoroPorzione;

	public Ricetta(List<Prodotto> elencoIngredienti, int numeroPorzioni, int caricoLavoroPerPorzione) {
	...
	public List<Prodotto> getElencoIngredienti() {
